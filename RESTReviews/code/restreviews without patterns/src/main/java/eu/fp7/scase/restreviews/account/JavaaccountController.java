...
public class JavaaccountController{
    ...
    private UriInfo oApplicationUri;
	    ...
	    public JavaaccountModel getaccount(@PathParam("accountId") int accountId){
	        GetaccountHandler oGetaccountHandler = new GetaccountHandler(accountId, oApplicationUri);
