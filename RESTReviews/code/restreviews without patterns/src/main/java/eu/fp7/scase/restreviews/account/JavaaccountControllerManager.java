...
public class JavaaccountControllerManager{
    ...
    private UriInfo oApplicationUri;
	    ...
	    public JavaaccountModel postaccount(JavaaccountModel oJavaaccountModel){
	        PostaccountHandler oPostaccountHandler = new PostaccountHandler(oJavaaccountModel, oApplicationUri);
	...
	@GET
	@Produces("application/JSON")
    public JavaaccountModelManager getaccountList(){
        GetaccountListHandler oGetaccountListHandler = new GetaccountListHandler(oApplicationUri);
