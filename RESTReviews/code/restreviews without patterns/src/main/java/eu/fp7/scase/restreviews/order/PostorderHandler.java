...
public class PostorderHandler{
    ...
    public PostorderHandler(int accountId, JavaorderModel oJavaorderModel, UriInfo oApplicationUri){
        ...
        oJavaorderModel.setaccount(this.oJavaaccountModel);
    }
    ...
    public JavaorderModel createHypermedia(JavaorderModel oJavaorderModel){
        ...
        oJavaorderModel.getlinklist().add(new HypermediaLink(String.format("%s%s/%d", oApplicationUri.getBaseUri(), oRelativePath, oJavaorderModel.getorderId()), String.valueOf(oJavaorderModel.getcoupon()), "GET", "Child", oJavaorderModel.getorderId()));
        oJavaorderModel.getlinklist().add(new HypermediaLink(String.format("%s%s/%d", oApplicationUri.getBaseUri(), oRelativePath, oJavaorderModel.getorderId()), String.valueOf(oJavaorderModel.getcoupon()), "PUT", "Child", oJavaorderModel.getorderId()));
        oJavaorderModel.getlinklist().add(new HypermediaLink(String.format("%s%s/%d", oApplicationUri.getBaseUri(), oRelativePath, oJavaorderModel.getorderId()), String.valueOf(oJavaorderModel.getcoupon()), "DELETE", "Child", oJavaorderModel.getorderId()));
