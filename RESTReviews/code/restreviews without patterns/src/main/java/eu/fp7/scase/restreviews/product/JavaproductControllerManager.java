...
public class JavaproductControllerManager{
    ...
    private UriInfo oApplicationUri;
	    ...
	    public JavaproductModel postaccountproduct(@PathParam("accountId")int accountId, JavaproductModel oJavaproductModel){
	        PostaccountproductHandler oPostaccountproductHandler = new PostaccountproductHandler(accountId, oJavaproductModel, oApplicationUri);
		...
		@Produces("application/JSON")
		@Consumes("application/JSON")
	    public JavaproductModel postorderproduct(@PathParam("orderId")int orderId, JavaproductModel oJavaproductModel){
	        PostorderproductHandler oPostorderproductHandler = new PostorderproductHandler(orderId, oJavaproductModel, oApplicationUri);
