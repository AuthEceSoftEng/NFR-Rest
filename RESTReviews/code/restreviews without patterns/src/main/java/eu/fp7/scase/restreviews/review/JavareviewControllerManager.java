...
public class JavareviewControllerManager{
    ...
    private UriInfo oApplicationUri;
	    ...
	    public JavareviewModel postreview(@PathParam("productId")int productId, JavareviewModel oJavareviewModel){
	        PostreviewHandler oPostreviewHandler = new PostreviewHandler(productId, oJavareviewModel, oApplicationUri);
	...
	@GET
	@Produces("application/JSON")
    public JavareviewModelManager getreviewList(@PathParam("productId")int productId){
        GetreviewListHandler oGetreviewListHandler = new GetreviewListHandler(productId, oApplicationUri);
