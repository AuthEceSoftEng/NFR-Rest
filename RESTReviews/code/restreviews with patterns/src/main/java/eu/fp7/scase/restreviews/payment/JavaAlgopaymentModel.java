...
/* JavaAlgopaymentModel class is responsible to model any data the payment resource handles. Since this one 
 is not automatable, the developer has to manually define it by providing its properties and setter/getter functions.*/
public class JavaAlgopaymentModel{

    /* There follows a list with the properties that model the payment resource, as prescribed in the service CIM*/
