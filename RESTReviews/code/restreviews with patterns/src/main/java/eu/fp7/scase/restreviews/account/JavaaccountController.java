...
public class JavaaccountController{
    ...
    private UriInfo oApplicationUri;
		...
		public JavaaccountModelRepresentation getaccount(@PathParam("accountId") int accountId, @DefaultValue("account_email_role") @QueryParam("representationName") String representationName){
