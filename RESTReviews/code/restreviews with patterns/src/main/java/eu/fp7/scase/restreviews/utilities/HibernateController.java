...
public class HibernateController{
	...
	public ArrayList<JavaorderMemento> getorderMementos(ArrayList<JavaorderMemento> SetOfJavaorderMemento){

        /* Create a new hibernate session and begin the transaction*/
        Session hibernateSession = HibernateUtil.getSessionFactory().openSession();
        Transaction hibernateTransaction = hibernateSession.beginTransaction();

        /* Retrieve the list of order resources that are needed.*/
        String strHibernateQuery = "FROM JavaorderMemento";
        Query hibernateQuery = hibernateSession.createQuery(strHibernateQuery);
        SetOfJavaorderMemento = new ArrayList(hibernateQuery.list());

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return SetOfJavaorderMemento;
    }
	
	
	public JavaorderMemento updateJavaorderMemento(JavaorderMemento oJavaorderMemento){
        ...
        /* Update the existing order of the database*/
        hibernateSession.update(oJavaorderMemento);

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return oJavaorderMemento;
    }

	public JavaorderMemento createJavaorderMemento(JavaorderMemento oJavaorderMemento){
        ...
        /* Insert the new order to database*/
        hibernateSession.save(oJavaorderMemento);
	...
	public JavaorderMemento deleteJavaorderMemento(JavaorderMemento oJavaorderMemento){
        ...
        /* Retrieve the existing order from the database*/
        oJavaorderMemento = (JavaorderMemento) hibernateSession.get(JavaorderMemento.class, oJavaorderMemento.getmementoId());

        /* Delete the existing order from the database*/
        hibernateSession.delete(oJavaorderMemento);
    ...
    public JavaorderMemento getorderMemento(JavaorderMemento oJavaorderMemento){
	...
	public ArrayList<JavareviewObserver> getreviewObservers(ArrayList<JavareviewObserver> SetOfJavareviewObservers){

        /* Create a new hibernate session and begin the transaction*/
        Session hibernateSession = HibernateUtil.getSessionFactory().openSession();
        Transaction hibernateTransaction = hibernateSession.beginTransaction();

        /* Retrieve the list of review resources that are needed.*/
        String strHibernateQuery = "FROM JavareviewObserver";
        Query hibernateQuery = hibernateSession.createQuery(strHibernateQuery);
        SetOfJavareviewObservers = new ArrayList(hibernateQuery.list());

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return SetOfJavareviewObservers;
    }

	public JavareviewObserver updateJavareviewObserver(JavareviewObserver oJavareviewObserver){
        ...
        /* Update the existing review of the database*/
        hibernateSession.update(oJavareviewObserver);

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return oJavareviewObserver;
    }

	public JavareviewObserver createJavareviewObserver(JavareviewObserver oJavareviewObserver){
        ...
        /* Insert the new review to database*/
        hibernateSession.save(oJavareviewObserver);
	...
	public JavareviewObserver deleteJavareviewObserver(JavareviewObserver oJavareviewObserver){
        ...
        /* Retrieve the existing review from the database*/
        oJavareviewObserver = (JavareviewObserver) hibernateSession.get(JavareviewObserver.class, oJavareviewObserver.getobserverId());

        /* Delete the existing review from the database*/
        hibernateSession.delete(oJavareviewObserver);
