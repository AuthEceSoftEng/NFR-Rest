...
public class PostorderproductHandler{
    ...
    public PostorderproductHandler(int orderId, JavaproductModel oJavaproductModel, UriInfo oApplicationUri){
        ...
        oJavaproductModel.setorder(this.oJavaorderModel);
    }
    ...
    public JavaproductModel createHypermedia(JavaproductModel oJavaproductModel){
        ...
        oRelativePath = String.format("account/%d/%s", this.oJavaorderModel.getaccount().getaccountId(), this.strResourcePath.replaceAll("multiproductManager/", ""));
